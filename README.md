...
Bienvenido a **Flavorwell App**, una aplicación web movil de tipo red social, en donde los usuarios pueden compartir sus platillos favoritos a el resto de la comunidad, con una interfaz intuitiva, colorida y facil de usar. 

## 📌 Características

✅ Sistema compartir recetas 🥯
✅ Listas de recetas 🥪
✅ Inicio de sesion para cada usuario 🌮
✅ Interfaz amigable y fácil de usar 🎨
✅️ Recomendacion de nuevas recetas 🍽
